// Модалки в тейк ордер ( какого то х не работает...)
...
//           '.order-modal[data-modal="' + modalId + '"]'
//         );
...
//     item.addEventListener('click', function (e) {
//       var parentModal = this.closest('.order-modal');
...
//       if (key == 27) {
//         document
//           .querySelector('.order-modal.active')
//           .classList.remove('active');
//         document
//           .querySelector('.order-modal__overlay')
//           .classList.remove('active');
//       }
//     },
//     false
